...
<html>
	...
	<head>
		...
		<title>
			<?php echo (C("QY_COMPANY")); ?>-预充订单</title>
	...
	<body ontouchstart="" style="background-color:#FAFAFA">
		<div class="page">
			<header class="bar bar-nav" style="background-color:#006db2;">
				...
				<h1 class="title" style="color:#fff">预充订单</h1>
			</header>
			<div class="content">
				<!-- searchbar -->
			...
			$('.order-list.all_odlist').each(function(index) {
				...
				if ($.isArray(odArray)&&odArray.length>index)
				{
					...
					$(this).find("#all_oddetail").click(function(){
						...
						{
							window.location.href="<?php echo U('./Kangli/Orders/orderdetail/od_id');?>/"+odObject['od_id'];
						}
					});
					...
					$(this).find("#all_odpingzheng").click(function(){
						if($.isPlainObject(odObject))
						{
							window.location.href="<?php echo U('./Kangli/Orders/uploadpaypic/od_id');?>/"+odObject['od_id'];
						}
					});
				}
			});
