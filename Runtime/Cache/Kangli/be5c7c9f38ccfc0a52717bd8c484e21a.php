...
<html>
	...
	<head>
		...
		<title><?php echo (C("QY_COMPANY")); ?>-关注微信</title>
	...
	<body ontouchstart="" style="background-color:#FAFAFA">
		<div class="page">
			<header class="bar bar-nav" style="background-color:#006db2;">
				...
				<h1 class="title" style="color:#fff">关注微信</h1>
			</header>
			<div class="content">
					<div class="content-block-title">请通过以下三种方式关注：</div>
 					<div class="card">
 						<div class="card-header"><div>1、官方微信： 请搜索公众号"康利科技"</div></div>
 						<div class="card-header"><div>2、通过长按二维码关注"康利科技"</div></div>
    					<div class="card-content">
      						<div class="card-content-inner">
		<p  class="ui-nowrap"  style="padding-left:18px"><img src="/Kangli/Public/Kangli/static/weixin.jpg"  style="width:90%"></p></div>
    					</div>
    					<div class="card-footer"><div>3、<a href="<?php echo ($bas_content); ?>">从这里进入文章,点击蓝色小字关注</a></div></div>
  					</div>
			</div>
		</div>
	</body>
