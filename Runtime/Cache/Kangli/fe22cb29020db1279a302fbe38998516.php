...
<html>
	...
	<head>
		...
		<title><?php echo (C("QY_COMPANY")); ?>邀请直属经销商</title>
	...
	<body ontouchstart="" style="background-color:#FAFAFA">
		<div class="page">
			<header class="bar bar-nav" style="background-color:#006db2;">
				...
				<a href="<?php echo U('./Kangli/Dealer/qyshare?ttamp='.$ttamp.'&sture='.$sture.'');?>" class="icon icon-left pull-left" style="color:#fff"></a>
				<h1 class="title" style="color:#fff">邀请直属经销商</h1>
			</header>
			<div class="content">
				<div class="kl-layout-center" style="text-align:center; padding-top:10px">代理级别：<?php if(!empty($dltypeinfo["dlt_name"])): echo ($dltypeinfo["dlt_name"]); endif; if(!empty($dlsttinfo["dlstt_name"])): echo ($dlsttinfo["dlstt_name"]); endif; ?></div>
