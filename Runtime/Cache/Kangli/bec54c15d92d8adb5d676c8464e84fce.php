...
<html>
	...
	<head>
		...
		<title>
			<?php echo (C("QY_COMPANY")); ?>-企业简介</title>
	...
	<body ontouchstart="" style="background-color:#FAFAFA">
		<div class="page">
			<header class="bar bar-nav" style="background-color:#006db2;">
				...
				<h1 class="title" style="color:#fff">企业简介</h1>
			</header>
			<div class="content">
				<div class="card">
					<div class="card-header" style="font-size: .6rem;"><b>企业简介</b></div>
					<div class="card-content">
						<div class="card-content-inner"><?php echo ($bas_content); ?></div>
					</div>
					<div class="card-footer" style="display: none;">卡脚</div>
				</div>
			</div>
		</div>
	</body>
