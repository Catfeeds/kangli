...
<html>
	...
	<head>
		...
		<title><?php echo (C("QY_COMPANY")); ?>邀请代理</title>
	...
	<body ontouchstart="" style="background-color:#FAFAFA">
		<div class="page">
			...
			<div class="content">
				            ...
				            <div class="kl-layout-horizontally-between" style="width: 100%;margin-bottom: 0.2rem; background: #fff">
				            	<div class="kl-layout-horizontally-between" style="width: 93%;">
	              				    <div class="item-content item-inner">
	              						<div class="item-subtitle" style="margin: .3rem 0"><?php echo ($item['br_name']); ?> <?php echo ($item['dlt_name']); ?> 邀请链接</div>
	            						<div class="item-title timeList" >打开:<?php echo ($item['sl_views']); ?> / 已申请:<?php echo ($item['sl_applynum']); ?>  倒计时:<span><?php echo ($item['timing']); ?></div>
	          						</div>
				...
				<form action="<?php echo U('./Kangli/Dealer/marklinks');?>" action="" enctype="multipart/form-data" method="get" id="fmmm" name="fmmm">
