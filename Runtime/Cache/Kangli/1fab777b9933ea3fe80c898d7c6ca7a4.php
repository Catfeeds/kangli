...
<html>
	<head>
		...
		<title><?php echo (C("QY_COMPANY")); ?>-返利提现</title>
	...
	<body ontouchstart="" style="background-color:#FAFAFA">
		<div class="page">
			<header class="bar bar-nav" style="background-color:#006db2;">
				...
				<a href="<?php echo U('./Kangli/Fanli/receivelist');?>" class="icon icon-left pull-left" style="color:#fff"></a>
				<h1 class="title" style="color:#fff">返利提现</h1>
			</header>
			<div class="content">
				<form action="<?php echo U('./Kangli/Fanli/recash_save');?>"  method="post" id="fmmm" name="fmmm" >
				         ...
				         <div class="item-content">
				          <div class="item-inner">
				            <div class="item-title label">开户银行</div>
								<div class="item-input">
									<input type="hidden" name="rc_bank"  id="rc_bank">
	...
	$(function() {
        ...
        $('#dl_bankname').picker({
			...
			//点击提交
				...
				if($("#rc_money").val() == "") {
					$.toast("可提现金额为0,只能提<?php echo ($jiangetime); ?>天前的返利");  
					return false; 
				}
