...
<link rel="stylesheet" type="text/css" href="/Kangli/Public/Kangli/css/demo.css"/>
	...
	<body ontouchstart="" style="background-color:#FAFAFA">
		<div class="page">
			...
			<div class="content">
				<div class="kl-layout kl-layout-horizontally-vcenter" style="background:transparent;margin-left:0.9rem"><div class="item-title label">上级代理：<?php echo ($dlbelong_name); ?></div></div>
				...
				<form action="<?php echo U('./Kangli/Dealer/apply');?>" action="" enctype="multipart/form-data" method="post" id="fmmm" name="fmmm">
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response.stat == '0') {
								...
								$("#img_file2").attr('src',"/Kangli/Public/uploads/temp/"+response.filename); 
								$("#img_div2").show();
                                 return true;
                            } else {
								alert('图片提交失败');
