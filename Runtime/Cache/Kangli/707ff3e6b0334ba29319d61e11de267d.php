...
<html>
	<head>
		...
		<title>康利科技</title>
		<link rel="stylesheet" type="text/css" href="/Public/Kangli/css/weui.min.css" />
		...
		<div class="page">
			...
			<nav class="bar bar-tab clear">
				<ul class="icon_lists clear">
					...
					<li>
						<a class="tab-item" href="<?php echo U('Kangli/Dealer/index');?>">
					...
					<li>
						<a class="tab-item" href="<?php echo U('Kangli/Orders/index');?>">
							<i class="iconfont icon-icon"></i>
							<div class="name">订单</div>
						</a>
					</li>
					<li>
						<a class="tab-item" href="<?php echo U('Kangli/Mine/index');?>">
			...
			<div class="content">
				...
				<div class="swiper-container">
					<div class="swiper-wrapper">
						<?php if($adlist|count > 0): if(is_array($adlist)): foreach($adlist as $key=>$item): if($item["ad_url"] == '' ): ?><div class="swiper-slide"><img style="width:100%;height:10rem" src="/Public/uploads/mobi/<?php echo ($item["ad_pic"]); ?>" alt=""></div>
									<?php else: ?>
									<a href="<?php echo ($item["ad_url"]); ?>">
										<div class="swiper-slide"><img style="width:100%;height:10rem" src="/Public/uploads/mobi/<?php echo ($item["ad_pic"]); ?>" alt=""></div>
									</a><?php endif; endforeach; endif; ?>
						<?php else: ?>
							<div class="swiper-slide"><img style="width:100%;height:10rem" src="/Public/uploads/mobi/<?php echo ($item["ad_pic"]); ?>"  onerror="this.src='/Public/Kangli/static/logo_icon.png'" alt=""></div><?php endif; ?>
					</div>
				...
				<div class="weui-grids">
					<a href="<?php echo U('./Kangli/About');?>" class="weui-grid">
						<div class="weui-grid__icon">
							<i class="iconfont icon-qiyejianjie" style="font-size:1.8rem; color:#006db8"></i>
						</div>
						<p class="weui-grid__label">简介</p>
					</a>
					<a href="<?php echo U('./Kangli/apply');?>" class="weui-grid">
						<div class="weui-grid__icon">
							<i class="iconfont icon-shenqingjiameng" style="font-size:1.8rem; color:#1295d9"></i>
						</div>
						<p class="weui-grid__label">申请</p>
					</a>
					<a href="<?php echo U('./Kangli/Zhengce');?>" class="weui-grid">
						<div class="weui-grid__icon">
							<i class="iconfont icon-zuixinzhengce" style="font-size:1.8rem; color:#04d0c4"></i>
						</div>
						<p class="weui-grid__label">政策</p>
					</a>
					<a href="<?php echo U('./Kangli/Wechat');?>" class="weui-grid">
						<div class="weui-grid__icon">
							<i class="iconfont icon-weixin2" style="font-size:1.8rem; color:#79d336"></i>
						</div>
						<p class="weui-grid__label">关注</p>
					</a>
					<a href="<?php echo U('./Kangli/Product/index/stock/1');?>" class="weui-grid">
						<div class="weui-grid__icon">
							<i class="iconfont icon-chanpinzhongxin" style="font-size:1.8rem; color:#f08519"></i>
						</div>
						<p class="weui-grid__label">产品</p>
					</a>
					<a href="<?php echo U('./Kangli/Agent/index/backtag/1');?>" class="weui-grid">
						<div class="weui-grid__icon">
							<i class="iconfont icon-beichaxun" style="font-size:1.8rem; color:#35b594"></i>
						</div>
						<p class="weui-grid__label">查询</p>
					</a>
					<a href="<?php echo U('./Kangli/News/huodong/news_type/4');?>" class="weui-grid">
						<div class="weui-grid__icon">
							<i class="iconfont icon-pyq" style="font-size:1.8rem; color:#79d336"></i>
						</div>
						<p class="weui-grid__label">素材圈</p>
					</a>
					<a href="<?php echo U('./Kangli/News/huodong/news_type/7');?>" class="weui-grid">
						<div class="weui-grid__icon">
							<i class="iconfont icon-huodong1" style="font-size:1.8rem; color:#de5c9c"></i>
						</div>
					...
					<ul>
						<li>
							<div class="item-content1">
								<div class="item-media1"><?php if($item["news_index"] == 0): ?><img src="/Public/Kangli/static/send_show.png" style="width:2.5rem;height:2.5rem;"><?php else: ?><img src="/Public/Kangli/static/send_show.png" style="width:2.5rem;height:2.5rem; visibility: hidden;"><?php endif; ?></div>
				...
				<div class="buttons-tab">
					...
					<a href="#tab3" class="tab-link button">
						...
						<div style="padding-bottom:.2rem;font-size: .3rem;line-height:.5rem;">新客户</div>
					</a>
				</div>
...
<!--  <script type="text/javascript">
	...
	<script type='text/javascript' src='/Public/Kangli/js/swiper.min.js' charset='utf-8'></script>
	<script type='text/javascript' src='/Public/Kangli/js/echarts.min.js' charset='utf-8'></script>
	<script type="text/javascript">
		$.init();
		$(function() {
            ...
            $('.item-content1').each(function(index) {
                ...
                if ($.isArray(mjxArray)&&mjxArray.length>index)
                {
                    ...
                    $(this).click(function(){
                        ...
                        {
                            window.location.href="<?php echo U('./Kangli//News/huodong');?>/"+"news_type/2";
                        }
                    }); 
                }
            });
			...
			{
				location.href = "<?php echo U('./Kangli/News');?>";
			});
			...
			$('.searchbar-cancel').click(function() {
				...
				if (!isEmpty(keyword))
				{
					 // window.location.href="<?php echo U('./Kangli/Product/index/keyword');?>/"+keyword;
			...
			var oauth="<?php echo ($oauth); ?>"||false;
			...
			// var oauthttamp="<?php echo ($oauthttamp); ?>"||''
			// var oauthtsture="<?php echo ($oauthtsture); ?>"||''
			// if (oauthtsture!='')
			// {
			// 	localStorage.setItem('oauthttamp',oauthttamp);
			// 	localStorage.setItem('oauthtsture',oauthtsture);
			// }
			// var oauthtsture=localStorage.getItem('oauthtsture');
			// console.log(oauthtsture);
			// if (oauthtsture==''||oauthtsture==undefined)
			// {
				// window.location.href="<?php echo U('./Kangli/index/startOauth');?>";
			// }else
			// {
				// try {
				// 	$.ajax({
				// 		type: 'POST',
				// 		url: '<?php echo U("./Kangli/Index/autoLogin");?>',
				// 		data:{},
				// 		dataType: 'json',
				// 		timeout: 30000,
