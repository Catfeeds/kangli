             ...
             <tr>     
			  ...
			  <tr>     
				  ...
				  <select name="smfr_dltype"   class="select"  >
					...
					<?php if(is_array($dltypelist)): $key = 0; $__LIST__ = $dltypelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><option value="<?php echo ($vo["dlt_id"]); ?>"  <?php if($vo["dlt_id"] == $smfrinfo["smfr_dltype"] ): ?>selected<?php endif; ?> ><?php echo ($vo["dlt_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                  </select>
				  </td>
			  </tr>
			   <tr>     
				  ...
				  <select name="smfr_countdate"   class="select"  >
					...
					<option value="2"  <?php if($smfrinfo["smfr_countdate"] == '2' ): ?>selected<?php endif; ?> >按年　</option>
                  </select>
				  </td>
			  </tr>
			   ...
			   <tr>     
				  ...
				  <td  class="txtleft" ><input type="text" size="8" maxlength="10"  name="smfr_minsale" class="input" value="<?php echo ($smfrinfo["smfr_minsale"]); ?>" > -- <input type="text" size="8" maxlength="10"  name="smfr_maxsale" class="input" value="<?php echo ($smfrinfo["smfr_maxsale"]); ?>" ></td>
			  </tr>
			   ...
			   <tr>     
				  ...
				  <select name="smfr_saleunit"   class="select"  >
					...
					<option value="2"  <?php if($smfrinfo["smfr_saleunit"] == '2' ): ?>selected<?php endif; ?> >销售数量　</option>
                  </select>
				  </td>
			  </tr>
			   ...
			   <tr>     
				  ...
				  <select name="smfr_fanlieval"   class="select"  >
					...
					<option value="2"  <?php if($smfrinfo["smfr_fanlieval"] == '2' ): ?>selected<?php endif; ?> >按销量X奖金返利　</option>
                  </select>
				  </td>
			  </tr>
