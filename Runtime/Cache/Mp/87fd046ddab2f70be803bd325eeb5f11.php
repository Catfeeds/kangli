...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">销售累计奖</A></div>
<div class="nav_r"></div>
</div>
...
<form action="<?php echo U('Mp/Fanli/salesreward');?>"   method="post" name="fmmm"  >
...
<th  width="15%" ><span>金额</span></th>
<th  width="15%" ><span>销量</span></th>
...
<td class="data"><span><?php echo ($item["sr_totalstr"]); ?> 元</span></td>
<td class="data"><span><?php echo ($item["sr_salesvolume"]); ?></span></td>
<td class="data"><span><?php echo (date('Y-m-d H:i:s',$item["sr_addtime"])); ?></span></td>
<td class="data"><span><?php echo ($item["sr_statestr"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Fanli/fanlidetail?fl_id='.$item['sr_flid'].'');?>">详细</a></span></td>
