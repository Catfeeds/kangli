...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Dlkucun/xnkclist');?>">代理库存</A> &gt;　<A href="#">代理库存详细</A></div>
<div class="nav_r"></div>
</div>
<div class="height10"></div>
<div>
<div style="float:left; width:40%">
<form action="<?php echo U('Mp/Dlkucun/xnkcprolist');?>"   method="post" name="fmmm">
<input type="text" size="20" maxlength="20"  name="pro_name"  class="input"   onfocus="if(this.value=='请填写代理账号')this.value=''" value="<?php echo ($pro_name); ?>" style="color:#999999">
<input type="hidden" name="dlid" value="<?php echo ($dl_id); ?>">　
...
<th  width="20%"   ><span>经销商编号</span></th>
<th  width="30%" ><span>产品名称</span></th>
<th  width="10%"  ><span>库存</span></th>
<th  width="20%"  ><span>操作</span></th>
</tr></thead>
<tbody>
<?php if(is_array($prolist)): foreach($prolist as $key=>$item): ?><tr class="<?php echo ($key%2 == 0?'odd':'even'); ?>" >
<td class="data" style="text-align:left"  ><span><?php echo ($dl_name); ?> (<?php echo ($dl_username); ?>)</span></td>
<td class="data" ><span><?php echo ($dl_number); ?></span></td>
<td class="data"><span><?php echo ($item["pro_name"]); ?></span></td>
<td class="data"><span><?php echo ($item["surplusqty"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Dlkucun/xnkcadd/dl_id');?>/<?php echo ($dl_id); ?>/pro_id/<?php echo ($item["pro_id"]); ?>">增加</a><!--　<a href="<?php echo U('Mp/Dlkucun/xnkccut?dl_id='.$item['dl_id'].'');?>">减少</a>--></span></td>
