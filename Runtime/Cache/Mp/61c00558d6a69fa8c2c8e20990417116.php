...
<div class="content">
<form action="<?php echo U('Mp/Orders/odshipscanres_save');?>"   method="post" name="fmmm" >
<input type="hidden" name="od_id" value="<?php echo ($od_id); ?>" />
<input type="hidden" name="odbl_id" value="<?php echo ($odbl_id); ?>" />
<input type="hidden" name="oddt_id" value="<?php echo ($oddt_id); ?>" />
<input type="hidden" name="ship_whid" value="<?php echo ($ship_whid); ?>" />
<textarea name="ship_remark" rows="0" cols="0"  style="visibility:hidden" ><?php echo ($ship_remark); ?></textarea>
<textarea name="ship_barcode" rows="0" cols="0" style="visibility:hidden" ><?php echo ($ship_barcode); ?></textarea>
             ...
             <tr>     
			  ...
			  <tr>     
			   ...
			   <tr>     
				  ...
				  <td  class="txtleft" >
                  <?php echo ($ordersbase["od_wh_name"]); ?>
		      </td>
			  </tr>
			   <tr>     
			   ...
			   <tr>     
				  ...
				  <td  class="txtleft" style="padding:10px 0 5px 0" >
				  有效条码：<?php echo ($success); ?>　　　无效条码：<?php echo ($fail); ?>　　　出货产品数(小标)：<?php echo ($scancount); ?>
		      </td>
			  </tr>
			  
			   <tr>     
                  <td height="40"  class="txtright" valign="top" style="padding-top:8px" >产品条码：</td>
				  <td  class="txtleft" >
				  <table width="70%" border="0" cellspacing="0" cellpadding="0" >
				  <?php if(is_array($msgs)): foreach($msgs as $key=>$item): ?><tr>     
                  <td height="30"  class="txtleft" ><?php echo ($item["barcode"]); ?></td>
				  <td  class="txtleft" >
                  <?php echo ($item["error"]); ?>
		          </td>
				  <td  class="txtleft" >
			  ...
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
             <input type="submit" name="Submit" value="确认出货" class="botton"   id="submit" >　　　　　　　<input name="" type="reset" value="返 回"  onClick="javascript:window.history.go(-1);" class="botton" >
            </td>
			  </tr>
			</table>
</form>
