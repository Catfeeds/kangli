...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Dljf/index');?>">代理积分</A>　&gt;　<A href="#"><?php echo ($atitle); ?></A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Dljf/changedjf_save');?>"   method="post" name="fmmm"  >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
              ...
              <?php if($dealerinfo["dl_name"] != '' ): ?><tr>     
                  <td height="40"   class="txtright" >经销商名称：</td>
				  <td class="txtleft" ><?php echo ($dealerinfo["dl_name"]); ?> <?php if($dealerinfo["dl_username"] != '' ): ?>(<?php echo ($dealerinfo["dl_username"]); ?>)<?php endif; ?></td>
			  </tr><?php endif; ?>
			  <?php if($dealerinfo["dl_number"] != '' ): ?><tr>
				  <td height="40"  class="txtright" > 经销商编号：</td>
				  <td  class="txtleft" > <?php echo ($dealerinfo["dl_number"]); ?>
				  </td>
			  </tr><?php endif; ?>
			   <tr>     
                  <td height="40"  class="txtright" >增/减：</td>
				  <td  class="txtleft" >
				  <select  name="zengjian" class="input"  ><option value="1">增加　</option><option value="2">减少　</option></select>
				  </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >积分数：</td>
				  <td  class="txtleft" ><input type="text" size="6" maxlength="5"  name="jf" class="input" value="" ></td>
			  </tr>

			   <tr>     
                  <td height="100"  class="txtright" >备注：</td>
			     <td  class="txtleft" ><textarea cols="50" rows="2" name="remark"  ></textarea></td>
			  </tr>

			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  ><input type="submit" name="Submit" value="<?php echo ($atitle); ?>" class="botton"  id="ssubmit" >　　　　<input name="" type="reset" value="返 回"  onClick="javascript:window.history.go(-1);" class="botton" >
            </td>
			  </tr>
			</table>
</form>
