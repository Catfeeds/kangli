...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Dljf/dljflist');?>">积分明细</A>　&gt;　<A href="#">详细</A></div>
<div class="nav_r"></div>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
                  <td height="40"   class="txtright" >积分代理：</td>
				  <td class="txtleft" ><?php echo ($dljfinfo["dl_name_str"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >积分：</td>
				  <td  class="txtleft" ><?php echo ($dljfinfo["dljf_jfstr"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >积分类型：</td>
				  <td  class="txtleft" ><?php echo ($dljfinfo["dljf_typestr"]); ?></td>
			  </tr>
			  <?php if(($dljfinfo["dljf_orderid"] != '') AND ($dljfinfo["dljf_orderid"] != '0') ): ?><tr>     
                  <td height="40"  class="txtright" >相关订单：</td>
				  <td  class="txtleft" ><?php echo ($dljfinfo["dljf_orderid"]); ?></td>
			  </tr><?php endif; ?>

			   <tr>     
                  <td height="40"  class="txtright" >备注说明：</td>
				  <td  class="txtleft" ><?php echo (nl2br($dljfinfo["dljf_remark"])); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >积分时间：</td>
				  <td  class="txtleft" ><?php echo (date('Y-m-d H:m:s',$dljfinfo["dljf_addtime"])); ?></td>
			  </tr>
