				...
				<div class="rightcontent">
					<div class="content_nav">
						<div class="nav_l">
							...
							<A href="<?php echo U('Mp/Storage/index');?>">入库记录</A>　&gt;　<A href="#">入库导入</A>
						</div>
						<div class="nav_r"></div>
					</div>
					<div class="height20"></div>
					<div class="content">
					<form action="<?php echo U('Mp/Storage/import_save');?>"   method="post" name="fmmm"  enctype="multipart/form-data" >
