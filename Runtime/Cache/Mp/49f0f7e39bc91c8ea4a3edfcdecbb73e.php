...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Dealer/index');?>">经销商管理</A>　&gt;　<A href="<?php echo U('Mp/Dealer/typelist');?>">经销商级别</A>　&gt;　<A href="#">经销商级别2</A></div>
<div class="nav_r"><?php if(($qypurview["99999"]) == "99999"): ?><a href="<?php echo U('Mp/Dealer/sttypeadd');?>">添加级别2</a><?php endif; ?></div>
</div>
<div class="height20"></div>
<div class="content">
<table class="table_results" >
<thead><tr>
<th  width="50%"  style="text-align:left" ><span>经销商级别2名称</span></th>
...
<td class="data" style="text-align:left" ><span><?php echo ($item["dlstt_name"]); ?></span></td>
<td class="data"  ><span><?php echo ($item["dlstt_level"]); ?></span></td>
<td class="data"  ><span><?php echo ($item["dcount"]); ?></span></td>
<td class="data"><span><a href="<?php echo U('Mp/Dealer/sttypeview?dlstt_id='.$item['dlstt_id'].'');?>">详细</a><?php if(($qypurview["99999"]) == "99999"): ?>　<a href="<?php echo U('Mp/Dealer/sttypeedit?dlstt_id='.$item['dlstt_id'].'');?>">修改</a>　<a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Dealer/dlsttdel?dlstt_id='.$item['dlstt_id'].'');?>';" >删除</a><?php endif; ?></span></td>
