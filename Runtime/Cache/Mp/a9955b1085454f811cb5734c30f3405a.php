...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Orders/cporders');?>">订单管理</A>　&gt;　<A href="#">订单产品出货结果</A></div>
<div class="nav_r"></div>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
                  <td height="30"  class="txtright" ></td>
				  <td  class="txtleft"  >
		      </td>
			  </tr>
			  ...
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
             <a href="<?php echo U('./Mp/Orders/cporderdetail?od_id='.$od_id.'&odbl_id='.$odbl_id.'');?>"  class="abotton" ><< 返回订单详细</a>
            </td>
			  </tr>
			</table>
