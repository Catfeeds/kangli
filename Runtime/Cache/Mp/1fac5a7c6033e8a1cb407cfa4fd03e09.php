...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Capital/yufukuan');?>">预付款明细</A>　&gt;　<A href="#">预付款详细</A></div>
<div class="nav_r"></div>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
             <tr>     
			   ...
			   <tr>     
                  <td height="40"  class="txtright" >资金类别：</td>
				  <td  class="txtleft" ><?php echo ($yfkinfo["yfk_typestr"]); ?></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >收款代理：</td>
				  <td  class="txtleft" ><?php echo ($yfkinfo["dl_name_str"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >付款代理：</td>
				  <td  class="txtleft" ><?php echo ($yfkinfo["dl_sendname_str"]); ?></td>
			  </tr>

			   <tr>     
                  <td height="40"  class="txtright" >金额：</td>
				  <td  class="txtleft" ><?php echo ($yfkinfo["yfk_moneystr"]); ?> 元</td>
			  </tr>
			  <?php if(($yfkinfo["yfk_orderid"] != '') AND ($yfkinfo["yfk_orderid"] != '0') ): ?><tr>     
                  <td height="40"  class="txtright" >相关订单号：</td>
				  <td  class="txtleft" ><?php echo ($yfkinfo["yfk_orderid"]); ?></td>
			  </tr><?php endif; ?>
			   <tr>     
                  <td height="40"  class="txtright"  >说明：</td>
			     <td  class="txtleft" ><?php echo ($yfkinfo["yfk_remark"]); ?></td>
			  </tr>
			  
			   <tr>     
                  <td height="40"  class="txtright" >时间：</td>
				  <td  class="txtleft" ><?php echo (date('Y-m-d H:i:s',$yfkinfo["yfk_addtime"])); ?></td>
			  </tr>
			  
			   <tr>     
                  <td height="40"  class="txtright" >状态：</td>
				  <td  class="txtleft" ><?php echo ($yfkinfo["yfk_state_str"]); ?></td>
			  </tr>
