...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
             <input type="submit" name="Submit" value="<?php echo ($atitle); ?>" class="botton" >&nbsp;&nbsp;&nbsp;&nbsp;<?php if($atitle2 != ''): ?><input type="submit" name="Submit" value="<?php echo ($atitle2); ?>" class="botton" ><?php endif; ?><a href="<?php echo U('Mp/Dealer/index?dl_type='.$dl_type.'&dl_status='.$dl_status.'');?>" class="botton"><< 返 回</a>
            </td>
			  </tr>
			</table>
</form>
