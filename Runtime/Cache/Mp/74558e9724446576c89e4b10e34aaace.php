...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>&gt;<A href="<?php echo U('Mp/Dealer/index');?>">系统管理</A>&gt;<A href="#"><?php echo ($atitle); ?></A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<div style="text-align:center; padding-top:50px">
<?php echo ($qybindwx_pic_str); ?><br/>
请使用微信扫描二维码进行直接绑定
</div>
</div>
</div>
