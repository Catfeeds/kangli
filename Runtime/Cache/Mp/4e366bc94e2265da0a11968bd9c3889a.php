...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Jfmobi/feedback');?>">留言反馈</A>　&gt;　<A href="#">留言详细</A></div>
<div class="nav_r"></div>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
				  ...
				  <td class="txtleft" ><?php echo ($feedbackdetail["fb_contact"]); ?>  <?php echo ($feedbackdetail["fb_username_str"]); ?></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >联系电话：</td>
				  <td  class="txtleft" >
				  <?php echo ($feedbackdetail["fb_tel"]); ?>
				  </td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >QQ：</td>
				  <td  class="txtleft" >
				  <?php echo ($feedbackdetail["fb_qq"]); ?>
				  </td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >Email：</td>
				  <td  class="txtleft" >
				  <?php echo ($feedbackdetail["fb_email"]); ?>
				  </td>
			  </tr>
			  <tr>     
                  <td height="40"   class="txtright" >留言内容：</td>
				  <td class="txtleft" ><?php echo ($feedbackdetail["fb_content"]); ?></td>
			  </tr>
			  <?php if($feedbackdetail["fb_recontent"] != ''): ?><tr>     
                  <td height="40"   class="txtright" >回复：</td>
				  <td class="txtleft" ><?php echo ($feedbackdetail["fb_recontent"]); ?></td>
			  </tr><?php endif; ?>
			   <tr>     
                  <td height="40"  class="txtright" >留言时间：</td>
				  <td  class="txtleft" >
				  <?php echo (date('Y-m-d H:i:s',$feedbackdetail["fb_addtime"])); ?>
				  </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >IP：</td>
				  <td  class="txtleft" >
				  <?php echo ($feedbackdetail["fb_ip"]); ?>
				  </td>
			  </tr>
