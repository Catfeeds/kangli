...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <?php if(is_array($typelist)): foreach($typelist as $key=>$item): ?><tr>     
                  <td height="50"  class="txtright" valign="top"  style="padding-top:5px"><?php echo ($item["dlt_name"]); ?>：</td>
				  <td  class="txtleft"  style="padding-bottom:20px; line-height:26px">
				  直推奖：<input    type="text"  size="6" maxlength="6"  name="pfl_fanli1<?php echo ($item["dlt_id"]); ?>"  class="input"  value="<?php echo (number_format($item["pfl_fanli1"],2,'.','')); ?>"   >
				   　间推奖：<input    type="text"  size="6" maxlength="6"  name="pfl_fanli2<?php echo ($item["dlt_id"]); ?>"  class="input"  value="<?php echo (number_format($item["pfl_fanli2"],2,'.','')); ?>"   >
					</td>
