...
<td class="data"><span><a href="<?php echo U('Mp/Dljf/dljfgift_active?gif_id='.$item['gif_id'].'&gif_active='.$item['gif_active'].'');?>" ><img src="/Kangli/Public/mp/static/<?php echo ($item['gif_active'] == 0?'no':'yes'); ?>.gif" /></a></span></td>
