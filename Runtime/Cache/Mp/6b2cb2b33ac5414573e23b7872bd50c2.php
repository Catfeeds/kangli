...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Shipment/appsubuserlist');?>">PDA出货授</A>　&gt;　<A href="#"><?php echo ($mtitle); ?></A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Shipment/appsubuseradd_save');?>"   method="post" name="fmmm" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			   ...
			   <tr>     
                  <td height="40"  class="txtright" >用户名：</td>
				  <td  class="txtleft" >
				  <?php if($subuserinfo["su_id"] == '0' ): ?><input    type="text" size="25" maxlength="32"  name="su_username"  class="input"  value=""   >  * 
				  <?php else: ?>
				  <?php echo ($subuserinfo["su_username"]); endif; ?>
		      </td>
			  </tr>
			  <tr>     
			  ...
			  <tr>     
                  <td height="40"  class="txtright" >名　称：</td>
				  <td  class="txtleft" >
