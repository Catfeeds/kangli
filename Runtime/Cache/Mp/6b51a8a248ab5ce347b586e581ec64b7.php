...
<script type="text/javascript" src="/Kangli/Public/mp/js/jquery-confirm.min.js"></script>
		<link rel="stylesheet" type="text/css" href="/Kangli/Public/mp/js/themes/default/easyui.css">
		<link rel="stylesheet" type="text/css" href="/Kangli/Public/mp/js/themes/icon.css">
	</head>
            ...
            $(obj).addClass("menu_sontitle");
				...
				<div class="rightcontent">
					<div class="content_nav">
						<div class="nav_l">
							<a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;
							<A href="#">入库扫描</A>
						</div>
						<div class="nav_r"></div>
					</div>
					...
					<div class="content">
						<form action="<?php echo U('Mp/Storage/add_save');?>" method="post" name="fmmm">
							<input type="hidden" name="stor_id" value="<?php echo ($storageinfo["stor_id"]); ?>" />
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td class="txtleft">
										<input type="text" size="25" maxlength="32" id="stor_number" name="stor_number" class="input" value="<?php echo ($storageinfo["stor_number"]); ?>"> *
									</td>
								</tr>
								<tr>
									...
									<td class="txtleft">
										<select name="stor_whid" id="stor_whid" class="select">
											...
											<?php if(is_array($warehouselist)): $key = 0; $__LIST__ = $warehouselist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><option value="<?php echo ($vo["wh_id"]); ?>" <?php if($storageinfo["stor_whid"] == $vo["wh_id"] ): ?>selected<?php endif; ?> >
													<?php echo ($vo["wh_name"]); ?>
								...
								<tr>
									...
									<td class="txtleft">
										<select name="stor_pro" class="select" id="stor_pro">
											...
											<?php if(is_array($productlist)): $key = 0; $__LIST__ = $productlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><option value="<?php echo ($vo["pro_id"]); ?>" <?php if($storageinfo["stor_pro"] == $vo["pro_id"] ): ?>selected<?php endif; ?> >
													<?php echo ($vo["pro_name"]); ?>
												</option><?php endforeach; endif; else: echo "" ;endif; ?>
										</select> *
									</td>
								</tr>
								<?php if((count($$storageinfo["proattrlist"])) > "0"): ?><tr>
								...
								<?php if(($qypurview["6004"]) == "6004"): ?><tr>
										<td height="40" class="txtright">生产日期：</td>
										<td class="txtleft">
											<input type="text" size="25" maxlength="32" name="stor_prodate" class="input" value="<?php echo ($storageinfo["stor_number"]); ?>">
										</td>
									</tr><?php endif; ?>
								<?php if(($qypurview["6004"]) == "6004"): ?><tr>
										<td height="40" class="txtright">生产批号：</td>
										<td class="txtleft">
											<input type="text" size="25" maxlength="32" name="stor_batchum" class="input" value="<?php echo ($storageinfo["stor_number"]); ?>">
										</td>
									</tr><?php endif; ?>
								<tr>
									<td height="40" class="txtright">条码扫描：</td>
									<td class="txtleft">
										<?php if($action == 'update' ): ?><span style="font-size:16px;font-weight:bold"><?php echo ($storageinfo["stor_barcode"]); ?></span>
											<?php else: ?>
											<input type="text" size="25" maxlength="32" name="stor_barcode" class="input" value="" id="stor_barcode" style="height:40px; line-height:40px;font-size:20px"> *<?php endif; ?>
								...
								<tr>
									<td height="60"></td>
									<td class="txtleft">
										<input type="submit" name="Submit" value="<?php echo ($mtitle); ?>" class="botton" id="submit">
										<?php if($action != 'update' ): ?><input type="reset" value="重新扫描" class="botton" /><?php endif; ?>
									</td>
								</tr>
							</table>
						</form>
...
<script>var myDate = new Date();$("#cyear").html(myDate.getFullYear());</script>
	...
	<script type="text/javascript" src="/Kangli/Public/mp/js/jquery.easyui.min.js"></script>
	<script type="text/javascript" src="/Kangli/Public/mp/js/locale/easyui-lang-zh_CN.js"></script>
	<script type="text/javascript" language="javascript">
		...
		var proattrs = <?php echo ($storageinfo["proattrlist"]); ?>;
		var procheckid=0;
		$(document).ready(function() {
			$("#stor_date").datebox("setValue", "<?php echo ($storageinfo["stor_datestr"]); ?>");
		});
