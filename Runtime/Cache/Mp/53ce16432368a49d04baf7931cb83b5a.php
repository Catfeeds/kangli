...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">入库记录</A></div>
<div class="nav_r"><?php if(($qypurview["13001"]) == "13001"): ?><a href="<?php echo U('Mp/Storage/add');?>">入库扫描</a><?php endif; if(($qypurview["13001"]) == "13001"): ?>　<a href="<?php echo U('Mp/Storage/import');?>">入库导入</a><?php endif; ?></div>
</div>
<div class="height10"></div>
<div>
<div style="float:left; width:30%">
<form action="<?php echo U('Mp/Storage/index');?>"   method="post" name="fmmm"  >
<input    type="text" size="25" maxlength="25"  name="keyword"  class="input"   onfocus="this.value=''"   value="<?php if(($keyword) == ""): ?>输入条码、入库单号<?php else: echo ($keyword); endif; ?>"   style="color:#999999"  >   <input type="submit" name="Submit" value="搜 索"  ></form>
</div>
...
<select name="czid"   class="select" style="width:120px"  >
					...
					<?php if(is_array($czuserlist)): $key = 0; $__LIST__ = $czuserlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><option value="<?php echo ($vo["stor_czid"]); ?>"  <?php if($vo["stor_czid"] == $stor_czid): ?>selected<?php endif; ?> ><?php echo ($vo["stor_czuser"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
...
<td class="data" ><span><?php echo ($vo["stor_barcode"]); ?></span></td>
<td class="data" ><span><?php echo ($vo["stor_number"]); ?></span></td>
<td class="data" ><span><?php echo ($vo["pro_number"]); ?></span></td>
<td class="data" ><span><?php echo ($vo["pro_name"]); ?></span></td>
<!-- <td class="data" ><span><?php echo ($vo["stor_color"]); ?>--<?php echo ($vo["stor_size"]); ?></span></td> -->
<td class="data" ><span><?php echo ($vo["stor_czuser"]); ?></span></td>
<td class="data" ><span><?php echo (date('Y-m-d',$vo["stor_date"])); ?></span></td>
<td class="data" ><span><?php echo ($vo["warehouse"]); ?></span></td>
<td class="data" ><span><?php echo ($vo["stor_proqty"]); ?></span></td>
<td class="data"><span><?php if($qypurview["30008"] == '30008' ): ?><a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除该记录,请谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Storage/delete?stor_id='.$vo['stor_id'].'');?>';" >删除</a><?php endif; ?></span></td>
<td class="data"><?php if(($vo["stor_remark"]) != ""): ?><span  title="<?php echo ($vo["stor_remark"]); ?>"  style="cursor:pointer" >...</span><?php endif; ?></td>
