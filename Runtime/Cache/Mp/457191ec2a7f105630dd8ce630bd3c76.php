...
<?php if(($qypurview["10012"]) == "10012"): ?><div  style="padding:20px 0 0 0; border-bottom:solid 1px #e2e9ee;font-weight:bold; width:70%; margin:0 auto; font-size:14px">保证金：</div>
             ...
             <tr>     
			  ...
			  <tr>     
				...
				<tr>     
				  ...
				  <td class="txtleft" >
				<?php if(($dealerinfo["dl_depositpic_str"]) != ""): ?><a href="/Kangli/Public/uploads/dealer/<?php echo ($dealerinfo["dl_depositpic"]); ?>" target="_blank" ><?php echo ($dealerinfo["dl_depositpic_str"]); ?></a><?php endif; ?> <input name="pic_file" type="file" /> (建议图片大小不要超500k)  <input type="hidden"  value="<?php echo ($dealerinfo["dl_depositpic"]); ?>" name="old_depositpic" />
                  </td>
			    </tr>
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
