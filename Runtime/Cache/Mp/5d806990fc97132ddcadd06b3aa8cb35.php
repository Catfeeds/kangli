...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Dealer/typelist');?>">经销商级别</A>　&gt;　<A href="<?php echo U('Mp/Dealer/sttypelist');?>">经销商级别2</A>　&gt;　<A href="#"><?php echo ($atitle); ?></A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Dealer/sttype_save');?>"   method="post" name="fmmm" >
<input type="hidden" value="<?php echo ($dlsttinfo["dlstt_id"]); ?>" name="dlstt_id" />
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <tr>     
				  ...
				  <td class="txtleft" ><input    type="text" size="25" maxlength="25"  name="dlstt_name"  class="input"  value="<?php echo ($dlsttinfo["dlstt_name"]); ?>"   >  * </td>
			  </tr>
			    <tr>     
                  <td height="40"   class="txtright" >级别：</td>
				  <td class="txtleft" >
				  <select name="dlstt_level"   class="select"  >
				  <option  value="0" <?php if(($dlsttinfo["dlstt_level"]) == "0"): ?>selected<?php endif; ?> >选择级别</option>
				  <option  value="1" <?php if(($dlsttinfo["dlstt_level"]) == "1"): ?>selected<?php endif; ?> >1　</option>
				  <option  value="2" <?php if(($dlsttinfo["dlstt_level"]) == "2"): ?>selected<?php endif; ?> >2　</option>
				  <option  value="3" <?php if(($dlsttinfo["dlstt_level"]) == "3"): ?>selected<?php endif; ?> >3　</option>
				  <option  value="4" <?php if(($dlsttinfo["dlstt_level"]) == "4"): ?>selected<?php endif; ?> >4　</option>
				  <option  value="5" <?php if(($dlsttinfo["dlstt_level"]) == "5"): ?>selected<?php endif; ?> >5　</option>
				  <option  value="6" <?php if(($dlsttinfo["dlstt_level"]) == "6"): ?>selected<?php endif; ?> >6　</option>
				  <option  value="7" <?php if(($dlsttinfo["dlstt_level"]) == "7"): ?>selected<?php endif; ?> >7　</option>
				  <option  value="8" <?php if(($dlsttinfo["dlstt_level"]) == "8"): ?>selected<?php endif; ?> >8　</option>
				  <option  value="9" <?php if(($dlsttinfo["dlstt_level"]) == "9"): ?>selected<?php endif; ?> >9　</option>
				  </select>  </td>
			  </tr>
			   <tr>     
                  <td height="40"   class="txtright" >推荐返利1级：</td>
				  <td class="txtleft" ><input    type="text" size="5" maxlength="5"  name="dlstt_fanli1"  class="input"  value="<?php echo ($dlsttinfo["dlstt_fanli1"]); ?>"   >   </td>
			  </tr>
			   <tr>     
                  <td height="40"   class="txtright" >推荐返利2级：</td>
				  <td class="txtleft" ><input    type="text" size="5" maxlength="5"  name="dlstt_fanli2"  class="input"  value="<?php echo ($dlsttinfo["dlstt_fanli2"]); ?>"   >   </td>
			  </tr>
