...
<td class="data"><span><?php if(($item["sm_mysalestr"] != '') AND ($item["sm_mysalestr"] != '0') ): ?>个人：<?php echo ($item["sm_mysalestr"]); endif; if(($item["sm_mysalestr"] != '') AND ($item["pro_price"] != '0') ): ?><br />团队：<?php echo ($item["sm_teamsalestr"]); endif; ?></span></td>
