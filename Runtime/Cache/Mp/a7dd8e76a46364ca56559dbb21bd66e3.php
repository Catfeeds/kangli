...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">大数据统计</A></div>
<div class="nav_r"><a href="javascript:fullScreen()">全屏显示</a></div>
</div>
<div class="content">
    <iframe id='content_body' src="<?php echo U('Mp/echarts/fullscreen');?>" frameborder="0" width="100%" height='100%'></iframe>
</div>
