...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Capital/recashlist');?>">提现记录</A>　&gt;　<A href="#">提现详细</A></div>
<div class="nav_r"> <?php if($back == '1' ): ?><a href="<?php echo U('Mp/Capital/recashlist');?>" class="abotton" >&lt;&lt; 返 回</a><?php else: ?><a href="javascript:window.history.go(-1);" class="abotton" >&lt;&lt; 返 回</a><?php endif; ?></div>
</div>
             ...
             <tr>     
			  ...
			  <tr>     
			   ...
			   <tr>     
				  ...
				  <td  class="txtleft" >
				  <?php if(($recashinfo["rc_pic_str"]) != ""): ?><a href="/Kangli/Public/uploads/orders/<?php echo ($recashinfo["rc_pic"]); ?>" target="_blank" ><?php echo ($recashinfo["rc_pic_str"]); ?></a><?php endif; ?> 
				  </td>
			  </tr>
			  ...
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
			 <?php if($back == '1' ): ?><a href="<?php echo U('Mp/Capital/recashlist');?>" class="abotton" >&lt;&lt; 返 回</a><?php else: ?><a href="javascript:window.history.go(-1);" class="abotton" >&lt;&lt; 返 回</a><?php endif; ?>
            </td>
