...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">PDA出货授权</A></div>
<div class="nav_r"><a href="<?php echo U('Mp/Shipment/appsubuseradd');?>">添加用户</a>　<a href="<?php echo U('Mp/Shipment/index');?>">返 回</a></div>
</div>
...
<td class="data" ><span><?php echo ($vo["su_username"]); ?></span></td>
...
<td class="data" ><span><a href="<?php echo U('Mp/Shipment/appsuactive?su_id='.$vo['su_id'].'&su_status='.$vo['su_status'].'');?>" ><img src="/Kangli/Public/mp/static/<?php echo ($vo['su_status'] == 0?'no':'yes'); ?>.gif" /></a></span></td>
<td class="data" ><span><a href="<?php echo U('Mp/Shipment/appsubuseredit?su_id='.$vo['su_id'].'');?>">修改</a>　<a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Shipment/appsudelete?su_id='.$vo['su_id'].'');?>';" >删除</a></span></td>
