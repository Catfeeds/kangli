...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Orders/xnorders');?>">订货订单</A>　&gt;　<A href="#">完成订货</A></div>
<div class="nav_r"><a href="javascript:window.history.go(-1);" >&lt;&lt; 返 回</a></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Orders/xnodfinishship_save');?>"   method="post" name="fmmm" >
<input type="hidden" name="od_id" value="<?php echo ($od_id); ?>" />
<input type="hidden" name="odbl_id" value="<?php echo ($odbl_id); ?>" />
<input type="hidden" name="od_express" value="5" />
<div class="detail" >
...
<img src="/Kangli/Public/uploads/product/<?php echo ($item["oddt_propic"]); ?>" style="vertical-align:middle; width:50%" /><?php endif; ?>
  ...
  <tr>
    ...
    <td>&nbsp;<textarea name="od_remark" rows="3" cols="40"><?php echo ($ordersinfo["od_remark"]); ?></textarea></td>
    <td class="txtright txtbold"  >&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
