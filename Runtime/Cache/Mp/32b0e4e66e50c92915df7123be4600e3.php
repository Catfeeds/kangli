...
<td class="data"><span>余：<?php echo (number_format($item["yfksurplus"],2,'.','')); ?>元 <br />冻：<?php echo (number_format($item["yfkfreezesum"],2,'.','')); ?>元 </span></td>
...
<td class="data"><span>
<a href="<?php echo U('Mp/Capital/yufukuan?dlusername='.$item['dl_username'].'');?>">预付明细</a>　<a href="<?php echo U('Mp/Capital/dlbalance?dlusername='.$item['dl_username'].'');?>">余额明细</a><br />
<a href="<?php echo U('Mp/Capital/yufukuanadd?dl_id='.$item['dl_id'].'');?>">增减预付</a>　<a href="<?php echo U('Mp/Capital/yueadd?dl_id='.$item['dl_id'].'');?>">增减余额</a>
</span></td>
