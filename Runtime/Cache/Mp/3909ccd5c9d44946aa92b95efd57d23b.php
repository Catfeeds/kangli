...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">库存统计</A></div>
<div class="nav_r"></div>
</div>
...
<thead><tr>
<th  width="40%"   style="text-align:left"><span>产品</span></th>
<!-- <th  width="20%"   ><span >颜色尺码</span></th> -->
<th  width="15%"   ><span >入库统计</span></th>
<th  width="15%"   ><span >出货统计</span></th>
...
<td class="data" ><span><?php echo ($vo["kucun"]); ?></span></td>
