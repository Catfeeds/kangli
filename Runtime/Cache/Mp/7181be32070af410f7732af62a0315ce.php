...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">微信出货授权</A></div>
<div class="nav_r"><a href="<?php echo U('Mp/Shipment/index');?>">返 回</a></div>
</div>
...
<td class="data" ><span><?php echo ($vo["su_weixin"]); ?></span></td>
<td class="data" ><span><?php echo ($vo["su_name"]); ?></span></td>
<td class="data" ><span><?php echo (date('Y-m-d H:i:s',$vo["su_logintime"])); ?></span></td>
<td class="data" ><span><a href="<?php echo U('Mp/Shipment/suactive?su_id='.$vo['su_id'].'&su_status='.$vo['su_status'].'');?>" ><img src="/Kangli/Public/mp/static/<?php echo ($vo['su_status'] == 0?'no':'yes'); ?>.gif" /></a></span></td>
<td class="data" ><span><a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Shipment/sudelete?su_id='.$vo['su_id'].'');?>';" >删除</a></span></td>
</tr><?php endforeach; endif; else: echo "" ;endif; ?>
</tbody>
</table>
<div class="height20"></div>
<div style="text-align:center; padding-top:40px">
<?php echo ($qysubuser_pic_str); ?><br />
1、未授权的请用微信扫描二维码申请。2、已授权的用微信扫描二维码进入操作
</div>
</div>
<div class="height20"></div>
</div>
