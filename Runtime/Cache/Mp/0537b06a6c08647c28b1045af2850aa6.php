             ...
             <tr>     
			  ...
			  <tr>     
			   ...
			   <tr>     
				  ...
				  <td  class="txtleft" >
				  <?php if(($jfgiftinfo["gif_pic_str"]) != ""): ?><a href="/Kangli/Public/uploads/product/<?php echo ($jfgiftinfo["gif_pic"]); ?>" target="_blank" ><?php echo ($jfgiftinfo["gif_pic_str"]); ?></a><?php endif; ?> <input name="pic_file" type="file" /> (建议图片大小:600X600) <input type="hidden"  value="<?php echo ($jfgiftinfo["gif_pic"]); ?>" name="old_gif_pic" />
				  </td>
			  </tr>
			   <tr>     
