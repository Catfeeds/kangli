...
<td class="data" ><span><a href="<?php echo U('Mp/Subuser/suactive?su_id='.$vo['su_id'].'&su_status='.$vo['su_status'].'');?>" ><img src="/Kangli/Public/mp/static/<?php echo ($vo['su_status'] == 0?'no':'yes'); ?>.gif" /></a></span></td>
