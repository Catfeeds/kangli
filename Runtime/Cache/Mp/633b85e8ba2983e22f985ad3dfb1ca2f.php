...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">代理库存</A></div>
<div class="nav_r"></div>
</div>
<div class="height10"></div>
<div>
<div style="float:left; width:40%">
<form action="<?php echo U('Mp/Dlkucun/xnkclist');?>"   method="post" name="fmmm"  >
...
<th  width="14%"   ><span>经销商编号</span></th>
...
<td class="data"><span><a href="<?php echo U('Mp/Dlkucun/xnkcprolist?dl_id='.$item['dl_id'].'');?>">库存详细</a>　<!--　<a href="<?php echo U('Mp/Dlkucun/xnkccut?dl_id='.$item['dl_id'].'');?>">减少</a>--><a href="<?php echo U('Mp/Orders/xnorders?dlusername='.$item['dl_username'].'');?>">订货单</a>　<a href="<?php echo U('Mp/Orders/cporders?dlusername='.$item['dl_username'].'');?>">发货单</a></span></td>
