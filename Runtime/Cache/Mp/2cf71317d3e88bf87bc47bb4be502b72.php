...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
             <tr>     
			  ...
			  <?php if(is_array($typelist)): foreach($typelist as $key=>$item): ?><tr>     
				  ...
				  <?php if(($item["pfl_fanli1"] != '') AND ($item["pfl_fanli1"] != 0 )): ?>直推奖：<?php echo ($item["pfl_fanli1_str"]); ?>　<?php endif; ?>
				  <?php if(($item["pfl_fanli2"] != '') AND ($item["pfl_fanli2"] != 0 )): ?>间推奖：<?php echo ($item["pfl_fanli2_str"]); ?>　<?php endif; ?>
				  <?php if(($item["pfl_fanli3"] != '') AND ($item["pfl_fanli3"] != 0 )): ?>间推奖2：<?php echo ($item["pfl_fanli3_str"]); ?>　<?php endif; ?>
				  <?php if(($item["pfl_fanli4"] != '') AND ($item["pfl_fanli4"] != 0 )): ?>间推奖3：<?php echo ($item["pfl_fanli4_str"]); ?>　<?php endif; ?>
				  <?php if(($item["pfl_fanli5"] != '') AND ($item["pfl_fanli5"] != 0 )): ?>间推奖4：<?php echo ($item["pfl_fanli5_str"]); ?>　<?php endif; ?>
				  <?php if(($item["pfl_fanli6"] != '') AND ($item["pfl_fanli6"] != 0 )): ?>间推奖5：<?php echo ($item["pfl_fanli6_str"]); ?>　<?php endif; ?>
				  <?php if(($item["pfl_fanli7"] != '') AND ($item["pfl_fanli7"] != 0 )): ?>间推奖6：<?php echo ($item["pfl_fanli7_str"]); ?>　<?php endif; ?>
				  <?php if(($item["pfl_fanli8"] != '') AND ($item["pfl_fanli8"] != 0 )): ?>间推奖7：<?php echo ($item["pfl_fanli8_str"]); ?>　<?php endif; ?>
				  <?php if(($item["pfl_fanli9"] != '') AND ($item["pfl_fanli9"] != 0 )): ?>间推奖8：<?php echo ($item["pfl_fanli9_str"]); ?>　<?php endif; ?>
				  <?php if(($item["pfl_fanli10"] != '') AND ($item["pfl_fanli10"] != 0 )): ?>间推奖9：<?php echo ($item["pfl_fanli10_str"]); ?>　<?php endif; ?>
				  <?php if(($item["pfl_maiduan"] != '') AND ($item["pfl_maiduan"] != 0 )): ?>买断返：<?php echo ($item["pfl_maiduan_str"]); endif; ?>
				  </td>
