...
<?php if($item["oddt_propic"] == '' ): ?><img src="/Kangli/Public/demo82/static/nophoto.jpg" style="vertical-align:middle; width:50%" />
<?php else: ?>
<img src="/Kangli/Public/uploads/product/<?php echo ($item["oddt_propic"]); ?>" style="vertical-align:middle; width:50%" /><?php endif; ?>
  ...
  <tr>
    ...
    <td>&nbsp;<?php echo ($ordersinfo["odbl_remark"]); ?></td>
    <td class="txtright txtbold"  >&nbsp;合计：</td>
    <td>&nbsp;<?php echo ($ordersinfo["odbl_total"]); ?> 元</td>
  </tr>
    <tr>
