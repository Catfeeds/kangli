...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Capital/recashlist');?>">提现记录</A>　&gt;　<A href="#">提现处理</A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Capital/recashdeal_save');?>"   method="post" name="fmmm"  enctype="multipart/form-data"  >
...
<?php if(($recashinfo["rc_state"]) == "0"): ?><tr>     
                  <td height="40"  class="txtright" >处理凭证：</td>
				  <td  class="txtleft" >
				  <?php if(($recashinfo["rc_pic_str"]) != ""): ?><a href="/Kangli/Public/uploads/orders/<?php echo ($recashinfo["rc_pic"]); ?>" target="_blank" ><?php echo ($recashinfo["rc_pic_str"]); ?></a><?php endif; ?> <input name="pic_file" type="file" />  <input type="hidden"  value="<?php echo ($recashinfo["rc_pic"]); ?>" name="old_rc_pic" />
				  </td>
			  </tr>
			  ...
			  <?php if(($balancestr) != ""): ?><tr>     
                  <td height="40"  class="txtright" ></td>
				  <td  class="txtleft"  style="color:#FF0000" ><?php echo ($balancestr); ?></td>
			  </tr><?php endif; ?>
			   <tr>     
                  <td height="40"  class="txtright"  >处理备注：</td>
			     <td  class="txtleft" ><br><textarea  name="rc_remark"   rows="4"  cols="40" ><?php echo ($recashinfo["rc_remark"]); ?></textarea><br><br></td>
			  </tr>
			 ...
			 <tr>     
                  <td height="40"  class="txtright" ></td>
				  <td  class="txtleft" >注：每个申请记录只能处理一次，确认处理完后不能再操作</td>
			  </tr><?php endif; ?>
