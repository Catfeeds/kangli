...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="#">入库统计</A></div>
<div class="nav_r"></div>
</div>
...
<form action="<?php echo U('Mp/Storage/stortongji');?>"   method="post" name="fmmm"  >
...
<?php if(is_array($warehouselist)): $key = 0; $__LIST__ = $warehouselist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><option value="<?php echo ($vo["wh_id"]); ?>"  <?php if($whid == $vo["wh_id"] ): ?>selected<?php endif; ?> ><?php echo ($vo["wh_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select>　
...
<thead><tr>
<th  width="50%"   style="text-align:left"><span>产品</span></th>
<!-- <th  width="30%"   ><span >颜色尺码</span></th> -->
<th  width="20%"   ><span >入库统计</span></th>
</tr></thead>
<tbody>
<?php if(empty($list)): ?><tr class="odd" >
<td class="data"  colspan="7"  style="text-align:center">没有记录</td>
</tr>
<?php else: ?>
...
<!-- <td class="data" ><span><?php echo ($vo["attr_color"]); ?>--<?php echo ($vo["attr_size"]); ?></span></td> -->
<td class="data" ><span><?php echo ($vo["count1"]); ?></span></td>
