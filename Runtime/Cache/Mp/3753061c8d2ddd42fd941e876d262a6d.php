...
<td class="data"><span><a  href="javascript:" rel="http://<?php echo ($web_host); ?>/Kangli/Public/uploads/mobi/<?php echo ($item["pics_name"]); ?>" class="copylinks" >复制图片链接</a> <a href="<?php echo U('Mp/Jfmobi/picedit?pics_id='.$item['pics_id'].'');?>" >修改</a> <a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Jfmobi/delete?pics_id='.$item['pics_id'].'');?>';" >删除</a></span></td>
