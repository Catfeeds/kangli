...
<select name="dl_status"   class="select"   onChange="document.location.href ='<?php echo U('Mp/Dealer/index');?>?dl_type=<?php echo ($dl_type); ?>&dl_status='+this.value;" >
...
　
<select name="dl_type"   class="select" style="width:140px" onChange="document.location.href ='<?php echo U('Mp/Dealer/index');?>?dl_status=<?php echo ($dl_status); ?>&dl_type='+this.value;" >
...
<td class="data"><span><a href="<?php echo U('Mp/Dealer/view?dl_id='.$item['dl_id'].'');?>">详细</a>　<?php if(($qypurview["10004"]) == "10004"): ?><a href="<?php echo U('Mp/Dealer/edit?dl_type='.$dl_type.'&dl_status='.$dl_status.'&dl_id='.$item['dl_id'].'');?>">修改</a>　<a href="<?php echo U('Mp/Dealer/review?dl_type='.$dl_type.'&dl_status='.$dl_status.'&dl_id='.$item['dl_id'].'');?>">审核/设置</a><?php endif; ?>　<?php if(($qypurview["10003"]) == "10003"): ?><a  href="#" onClick="javascript:var truthBeTold = window.confirm('该操作将彻底删除,谨慎操作!'); if (truthBeTold) window.location.href='<?php echo U('Mp/Dealer/delete?dl_id='.$item['dl_id'].'');?>';" >删除</a><?php endif; ?></span></td>
