...
<td class="data"><span><a href="<?php echo U('Mp/Capital/recashdetail?rc_id='.$item['rc_id'].'');?>">详细</a><?php if(($item["rc_sdlid"] == '0') AND ($item["rc_state"] == '0') ): ?>　<a href="<?php echo U('Mp/Capital/recashdeal?rc_id='.$item['rc_id'].'');?>">处理</a><?php endif; ?></span></td>
