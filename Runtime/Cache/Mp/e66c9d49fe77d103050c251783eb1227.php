...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Orders/xnorders');?>">订单管理</A>　&gt;　<A href="#">订货订单</A></div>
<div class="nav_r"></div>
</div>
<div class="height10"></div>
<div>
<div style="float:left; width:30%">
<form action="<?php echo U('Mp/Orders/xnorders');?>"   method="post" name="fmmm"  >
...
<?php if($item2["oddt_propic"] == '' ): ?><img src="/Kangli/Public/demo82/static/nophoto.jpg" style="vertical-align:middle; width:10%" />
<?php else: ?>
<img src="/Kangli/Public/uploads/product/<?php echo ($item2["oddt_propic"]); ?>" style="vertical-align:middle; width:10%" /><?php endif; ?>
　<?php echo ($item2["oddt_proname"]); ?>  (<?php echo ($item2["oddt_pronumber"]); ?>) </span></td>
<td class="data"><span><?php if($item2["oddt_dlprice"] != '' ): ?>单价：<?php echo (number_format($item2["oddt_dlprice"],2,'.','')); ?> 元<?php endif; ?><br>订购：<?php echo ($item2["oddt_qty"]); echo ($item2["oddt_prounits"]); echo ($item2["oddt_totalqty"]); ?></span></td>
...
<td class="data"  rowspan="<?php echo ($item["countdetail"]); ?>" ><span><?php echo (number_format($item["odbl_total"],2,'.','')); ?> 元</span></td>
