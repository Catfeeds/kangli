...
<div class="nav_l"><a href="<?php echo U('Mp/Index/index');?>">首页</a>　&gt;　<A href="<?php echo U('Mp/Dlkucun/xnkclist');?>">代理库存</A>　&gt;　<A href="#">增加库存</A></div>
<div class="nav_r"></div>
</div>
<div class="height20"></div>
<div class="content">
<form action="<?php echo U('Mp/Dlkucun/xnkcadd_save');?>"   method="post" name="fmmm"    >
<input type="hidden" value="<?php echo ($dealerinfo["dl_belong"]); ?>" name="dl_belong" />
<input type="hidden" value="<?php echo ($dealerinfo["dl_id"]); ?>" name="dl_id" />
<input type="hidden" value="<?php echo ($prolist["0"]["pro_id"]); ?>" name="pro_id" />
<input type="hidden" value="<?php echo ($dealerinfo["dl_belong_stock"]); ?>" name="dl_belong_stock" />
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
             <tr>     
			    ...
			    <tr>     
                  <td height="40"  class="txtright" ><span style="font-size:16px">增加库存　</span></td>
				  <td  class="txtleft" ></td>
			  </tr>
			  <tr>     
                  <td height="40"  class="txtright" >代理：</td>
				  <td  class="txtleft" ><?php echo ($dealerinfo["dl_name_str"]); ?></td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >产品：</td>
				  <td  class="txtleft" >
				  <?php echo ($prolist["0"]["pro_name"]); ?> (<?php echo ($prolist["0"]["pro_number"]); ?>)
				  
				  </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >代理上家：</td>
				  <td  class="txtleft" ><?php echo ($dealerinfo["dl_belong_str"]); ?></td>
			  </tr>
			  <?php if($dealerinfo["dl_belong"] > '0' ): ?><tr>     
                  <td height="40"  class="txtright" >上家库存：</td>
				  <td  class="txtleft" ><?php echo ($dealerinfo["dl_belong_stock"]); ?></td>
			  </tr><?php endif; ?>
			   <tr>     
                  <td height="40"  class="txtright" >增加库存：</td>
				  <td  class="txtleft" ><input type="text" size="8" maxlength="8"  name="kc_add" class="input" value="" >   </td>
			  </tr>
			   <tr>     
                  <td height="40"  class="txtright" >备注：</td>
				  <td  class="txtleft" ><input type="text" size="60" maxlength="100"  name="kc_remark" class="input" value="" > </td>
			  </tr>
			  ...
			  <tr>  <td height="60" ></td>
                    <td  class="txtleft"  >
             <input type="submit" name="Submit" value="确认提交" class="botton" >　　　　<input name="" type="reset" value="返 回"  onClick="javascript:window.history.go(-1);" class="botton" >
            </td>
